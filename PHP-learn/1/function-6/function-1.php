...
function test ($number = null){  // = null means when you didnt pass anything to $number , we dont see any error and the value of $number = null
...
function test1 (&$number1 = null){  //& means it is argument by reference ! it means  the original $number change with function!!
